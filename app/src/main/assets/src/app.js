...
function ensureUploadChooserCameraBtn(){
  ...
  if(container && !document.getElementById('uploadChoiceCameraCard')){
    ...
    card.innerHTML = '<div class="upload-choice-icon" style="background:linear-gradient(135deg,#FF2A85,#8A2BE2);color:#fff;border-radius:12px;width:40px;height:40px;display:flex;align-items:center;justify-content:center;font-size:20px;box-shadow:0 4px 12px rgba(255,42,133,0.35);">📸</div><div class="upload-choice-text"><b>Camera & Story Maker</b><span>Capture with live filters, lenses & edit your photo</span></div>';
